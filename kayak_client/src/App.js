...
import EditUserProfile from './components/searchbars/edit_user_profile';
        ...
        return (
            <div className="App">
                <Router history={history}>
                    <MuiThemeProvider>
                        <Route  exact path="/" render ={() => (<SearchFlight/>)}/>
                        ...
                        <Route  exact path="/edituserprofile" render ={() => (<EditUserProfile/>)}/>
