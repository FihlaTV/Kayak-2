...
export const addCarAdmin = function(cardetail){
    ...
    return (dispatch) => {
        fetch(`${server_url}/cars/addCar`, {
            ...
            if(res.status === 200){
                alert(" New car with model:"+cardetail.car_model_no+" is added successfully !!!");
                history.push('/admindashboard');
            }else{
...
export const addFlightAdmin = function(flightdetail){
    ...
    return (dispatch) => {
        fetch(`${server_url}/flights/addFlight`, {
            ...
            if(res.status === 200){
                alert(" New flight with carrier:"+flightdetail.flight_carrier_name+" is added successfully !!!");
                history.push('/admindashboard');
            }else{
...
export const adminCarDelete = function(data, last_search){
    ...
    return (dispatch) => {
        fetch(`${server_url}/admin/deletecar`, {
            method: 'POST',
            credentials:'include',
            mode: 'cors',
            headers: { ...headers,'Content-Type': 'application/json' },
...
export const handleCarUpdate = function(cardetail){
    ...
    return (dispatch) => {
        fetch(`${server_url}/admin/updatecaradmin`, {
            ...
            if(res.status === 201){
                alert(" updated car with id:"+cardetail.car_model_no+" successfully !!!");
                history.push('/admindashboard');
            }else{
