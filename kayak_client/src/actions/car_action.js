...
export function searchcars_action(payload){
    console.log("its date in searchcar action"+payload.car_src_city);
    return dispatch => {
            ...
            .then(
                response => {
                    ...
                    else
                    {
                        ...
                        alert("Oopss!! Failed to find car from: "+payload.car_src_city+"..Try again!!!");
                    }
                }
            );
