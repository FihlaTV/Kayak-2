...
class HomePageHeader1 extends Component {
    constructor(props) {
        super(props);
        this.state = {
            value: 1,
            ...
            <nav className="navbar navbar-inverse navbar-top">
                <div className="container">
                    ...
                    <ul className="nav navbar-nav navbar-right">
                        <li>
                            <Nav>
                            <NavDropdown style={{height:"50px"}} eventKey={4} title="My Account">
                                <MenuItem eventKey={4.1} onClick={this.handle_profile}>Profile</MenuItem>
                                <MenuItem eventKey={4.2} onClick={this.handle_logout}>Log Out</MenuItem>
                            </NavDropdown>
                            </Nav>
                        </li>
                    {/*<li><a href="/userprofile">User</a></li>*/}
                                        ...
                                        {/*<div className="modal-body" style={{textAlign:"center"}}>*/}
                                            ...
                                            {/*<form style={{textAlign:"center", marginTop:"4%"}}>*/}
                                                {/*<div className="form-group" style={{textAlign:"center", marginLeft: '21%'}}>*/}
                                                    ...
                                                    {/*</div>*/}
                                                    {/*<button type="button" className="btn btn-info" style={{display: "flex",marginLeft: '25%'}} onClick={this.handleSubmit}>*/}
                                                        {/*Login </button>*/}
                                                {/*</div>*/}
                                            {/*</form>*/}
                                        {/*</div>*/}
                                        ...
                                        {/*<div className="modal-body">*/}
                                            ...
                                            {/*<form style={{textAlign:"center", marginTop:"4%"}}>*/}
                                                {/*<div className="form-group" style={{textAlign:"center", marginLeft: '21%'}}>*/}
                                                    ...
                                                    {/*</div>*/}
                                                    {/*<button type="button" className="btn btn-info" style={{display: "flex",marginLeft: '25%'}} onClick={this.handleSubmit1}>*/}
                                                        {/*Sign Up </button>*/}
                                                {/*</div>*/}
                                            {/*</form>*/}
...
function mapDispatchToProps(dispatch) {
    return bindActionCreators({signin_action:useraction.signin_action, signup_action: useraction.signup_action,logout:useraction.logout},dispatch);
}
export default connect(null,mapDispatchToProps)(HomePageHeader1);
