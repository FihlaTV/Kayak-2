        ...
        return (
            <div >
                <Navbar inverse collapseOnSelect>
                    ...
                    <Navbar.Collapse>
                        <Nav>
                            <NavDropdown style={{height:"50px"}} eventKey={1} title="Cars">
                            ...
                            <NavDropdown style={{height:"50px"}} eventKey={2} title="Flights" >
                            ...
                            <NavDropdown style={{height:"50px"}} eventKey={3} title="Hotels">
                        ...
                        <Nav pullRight>
                            <NavDropdown style={{height:"50px"}} eventKey={4} title="My Admin">
