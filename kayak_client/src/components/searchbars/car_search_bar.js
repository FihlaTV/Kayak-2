              ...
              <div className="container-fluid" style = {{height:250}}>
                  ...
                  <div className="container-fluid pull-left" style={{fontSize:13,paddingTop:30,paddingLeft:30}}>
                      ...
                      <div className="form-group" style={{marginTop:"6%"}} >
                          ...
                          placeholder="Where" name="car_src_city" value={cardetails.car_src_city} style={{marginLeft:2,height:70,fontSize:17}} onChange={this.handleChange}/>
                          <input type="text"  className="TextField col-sm-3 col-md-3 col-lg-3" id="deslocation"
                          placeholder="To" name="car_destination_city" value={cardetails.car_destination_city} style={{marginLeft:2,height:70, fontSize:17}} onChange={this.handleChange}/>
