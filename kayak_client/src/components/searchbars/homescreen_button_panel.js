...
class HomeScreenButtonPanel extends Component {
    ...
    render() {
        return (
            <div className="hbutton-panel" style={{marginLeft: "35%"}}>
                <button className="homescreeen-button" type="button"
                        onClick={() => this.handleHotel()}><span id="flight-icon"><img src={hotelIcon}/></span> &nbsp;
                    Hotels
                </button>
                <button className="homescreeen-button" type="button"
                        onClick={() => this.handleFlight()}><span id="flight-icon"><img src={flightIcon}/></span> &nbsp;
                    Flights
                </button>
                <button className="homescreeen-button" type="button"
                        onClick={() => this.handleCar()}><span id="flight-icon"><img src={carIcon}/></span> &nbsp;Cars
                </button>
            </div>
        );
    }
